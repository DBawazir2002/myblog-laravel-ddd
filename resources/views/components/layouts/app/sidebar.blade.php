                ...
                <div class="h-full flex flex-col">
                    ...
                    <nav class="flex-1 overflow-y-auto custom-scrollbar py-4">
                        <ul class="space-y-1 px-2">
                            <!-- Dashboard -->
                            <x-layouts.sidebar-link href="{{ route('dashboard.index') }}" icon='fas-house' class=""
                                :active="Route::currentRouteName() == 'dashboard.index'">{{__('keywords.dashboard')}}</x-layouts.sidebar-link>
                            <x-layouts.sidebar-link href="{{ route('dashboard.categories.index') }}" icon='fas-tags'
                                                    :active="request()->routeIs('*categories*')">{{__('keywords.categories')}}</x-layouts.sidebar-link>

                            <x-layouts.sidebar-link href="{{ route('dashboard.posts.index') }}" icon='fas-pager'
                                                    :active="request()->routeIs('*posts*')">{{__('keywords.posts')}}</x-layouts.sidebar-link>
