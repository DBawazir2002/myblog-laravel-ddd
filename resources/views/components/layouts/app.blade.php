            ...
            <main class="flex-1 overflow-auto bg-gray-100 dark:bg-gray-900 content-transition">
                <div class="p-6">
                    ...
                    <div x-data="{ showStatusMessage: true }"
                         ...
                         x-transition:leave-start="opacity-100 transform translate-y-0"
                         x-transition:leave-end="opacity-0 transform -translate-y-2"
                         @keydown.escape.window="showStatusMessage = false"
                         class="mb-4 bg-orange-50 dark:bg-orange-900/30 border-l-4 border-orange-500 dark:border-orange-400 p-4 rounded-md shadow-sm"
                         role="alert">
                        <div class="flex items-start">
                            <div class="flex-shrink-0 pt-0.5">
                                <svg class="h-5 w-5 text-orange-500 dark:text-orange-400"
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-sm font-medium text-orange-800 dark:text-orange-100">{{ session('warning') }}</p>
                            </div>
                            <div class="ml-4 flex-shrink-0 flex">
                                <button @click="showStatusMessage = false"
                                        class="inline-flex rounded-md text-orange-500 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-orange-50 dark:focus:ring-offset-orange-900/30 focus:ring-orange-500"
                                        :aria-label="{{ json_encode(__('Dismiss')) }}">
                    ...
                    <div x-data="{ showStatusMessage: true }"
                         ...
                         x-transition:leave-end="opacity-0 transform -translate-y-2"
                         @keydown.escape.window="showStatusMessage = false"
                         class="mb-4 bg-red-50 dark:bg-red-900/30 border-l-4 border-red-500 dark:border-red-400 p-4 rounded-md shadow-sm"
                         role="alert">
                        <div class="flex items-start">
                            <div class="flex-shrink-0 pt-0.5">
                            ...
                            <div class="ml-4 flex-shrink-0 flex">
                                <button @click="showStatusMessage = false"
                                        class="inline-flex rounded-md text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-50 dark:focus:ring-offset-red-900/30 focus:ring-red-500"
                                        :aria-label="{{ json_encode(__('Dismiss')) }}">
                                    <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd"
                                              d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
